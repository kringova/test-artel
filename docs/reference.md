...
_templates/
  ...
  roadmap.md         шаблон роадмапа проекта
...
skills/
  ...
  onboard/SKILL.md   поднять канон существующего проекта (brownfield)
  charter/SKILL.md   собрать проектный канон с нуля (greenfield)
docs/
